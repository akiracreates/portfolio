    ...
    chapters: [
      {
        ...
        tilt: "-2deg",
        body: [
          "рисование всегда было где-то рядом. даже в садике я спрашивала одноклассников, хотят ли они, чтобы я их нарисовала, и относилась к этому куда серьезнее, чем, наверное, стоило.",
          ...
          "даже тогда искусство уже ощущалось естественным, захватывающим и иногда настолько фрустрирующим, что я могла расплакаться из-за деталей, которые никому особо не были важны.",
        ],
        images: [
          {
            id: "kindergarten",
      ...
      },
      {
        ...
        noteCard: {
          label: "переход",
          body: [
            "с digital art я познакомилась примерно в 8 лет, когда получила свой первый ipad air. до стилуса я ещё долго рисовала просто пальцем — другого варианта у меня не было.",
            "начала с случайных детских приложений для рисования, потом перешла в ibis paint, а позже в procreate. в следующие годы я буквально утонула в экспериментах с кистями, цветами, рендером и всем новым, что находила в интернете.",
            "многие мои ранние digital-работы были, честно, полным хаосом: грязные тени, агрессивный airbrush, слишком много smudge tool и неон везде. портреты я полюбила с самого начала, но животных тоже рисовала постоянно — особенно котов.",
            ...
            "в 11 лет я продала свой первый коммишен, когда искала клиентов через reddit. кто-то заказал у меня портрет кота через приватный pet-сабреддит, и я до сих пор храню эту работу.",
            "это ощущалось одновременно волнующе, очень поддерживающе и как-то по-взрослому — будто искусство вдруг стало чем-то более реальным, чем просто хобби.",
            "в те годы я ещё сильно зависела от соцсетевого одобрения: постоянно проверяла уведомления, сравнивала себя с другими художниками и завязывала самооценку на охватах и прогрессе.",
            "потом мне стало интересно и программирование — partly из-за моего парня азима, partly потому что оно в каком-то смысле похоже на искусство: бесит, креативит, требует техники и очень радует, когда наконец всё работает.",
          ],
        },
        images: [
          {
      ...
      },
      {
        ...
        body: [
          ...
          "иногда странно смотреть на них назад. сдвиг в мышлении просто огромный.",
        ],
        note: {
      ...
      },
      {
        ...
        tilt: "2deg",
        body: [
          "взрослеть как self-taught художница в интернете — это не всегда про стабильность. всегда находился кто-то, с кем сравнить себя, новый стиль, который хотелось попробовать, и техника, которая \"точно должна была починить\" мои работы.",
          "я постоянно экспериментировала: digital painting, акварель, масло, акрил, гуашь, глина, вязание, resin — в основном потому что мне правда нравится создавать вещи, но ещё и потому что я всё время искала, где можно стать лучше.",
      ...
      },
      {
        ...
        body: [
          ...
          "мне кажется, у меня уже есть узнаваемый стиль, но я не искала его специально. он вырос из долгих экспериментов и обучения, ресерча и практики, мотивации и настойчивости. и мне нравится мысль, что он будет продолжать меняться вместе со мной.",
        ],
        image: {
          label: "сейчас",
