  ...
  pages: [
    {
      ...
      labelKey: "nav.about",
      sections: [
        { id: "about-overview", anchor: "overview", labelKey: "nav.aboutOverview" },
        { id: "about-started", anchor: "how-it-started", labelKey: "nav.aboutStarted" },
        { id: "about-digital", anchor: "digital-art", labelKey: "nav.aboutDigital" },
        { id: "about-timeline", anchor: "timeline", labelKey: "nav.aboutTimeline" },
        { id: "about-ups-downs", anchor: "ups-and-downs", labelKey: "nav.aboutUpsDowns" },
        { id: "about-now", anchor: "where-i-am-now", labelKey: "nav.aboutNow" },
      ],
    },
