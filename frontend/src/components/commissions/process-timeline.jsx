  ...
  return (
    <div className="relative">
      <span
        ...
        aria-hidden
      />
      <ol className="space-y-4 max-md:space-y-5 md:space-y-5">
        {steps.map((step) => (
          <li
            key={step.step}
            className="relative z-[1] grid grid-cols-[2.5rem_minmax(0,1fr)] items-start gap-3 max-md:gap-3.5 md:grid-cols-[2.75rem_minmax(0,1fr)] md:gap-5"
          >
            <div className="relative flex min-h-full justify-center pt-4 max-md:pt-3">
            ...
            <article
              className={`scrap-note border-[color:var(--border-accent)]/28 max-md:border-[color:var(--border-accent)]/22 bg-[color:var(--bg-note)] p-4 max-md:p-5 md:p-5 ${
